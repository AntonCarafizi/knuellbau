	...
	class MetaSliderPlugin {
		...
		public function create_slider() {
			...
			if ( isset( $theme['folder'] ) ) {
				update_post_meta( $id, 'metaslider_slideshow_theme', $theme );
			}
		...
		public function render_admin_page() {
			...
			$theme_id    = is_wp_error( $theme ) ? false : $theme['folder'];
            ...
            <div id="metaslider-ui" class="metaslider metaslider-ui min-h-screen p-0 pb-24 bg-gray-lightest">
                ...
                <metaslider
                        ...
                        inline-template>
			<span>
			<form @keydown.enter.prevent="" id="ms-form-settings" accept-charset="UTF-8"
                  action="<?php echo admin_url( 'admin-post.php' ); ?>" method="post"
                  :class="{ 'respect-ie11': isIE11 }">
				...
				<div v-if="current && current.hasOwnProperty('id')" id='poststuff' class="metaslider-inner wp-clearfix">
					<div class="mt-10 mb-6">
						<?php if ( metaslider_viewing_trashed_slides( $this->slider->id ) ) {
                            ...
                            <h3 class="flex float-left m-0 mr-2"><i><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                ...
                                                x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg></i> <?php _e( 'Trashed Slides', 'ml-slider' ); ?></h3>
                        ...
                        <div style="min-width:300px;width:300px" class="mx-4">
                            ...
                            <?php } else { ?>
                                ...
                                <div class="ms-postbox" id="metaslider_configuration">
                                    <div class="inside wp-clearfix">
                                        ...
                                        if ( ! metaslider_viewing_trashed_slides( $this->slider->id ) ) { ?>
                                            <a <?php echo $count ? '' : "style='display:none;'" ?> class="restore-slide-link tipsy-tooltip-top flex text-blue-dark hover:text-orange -mb-2 mt-1 -mr-2 rtl:float-left rtl:-ml-1 rtl:mr-0"
                                                                                                   title="<?php _e( 'View trashed slides', 'ml-slider' ); ?>"
                                                                                                   href="<?php echo admin_url( "admin.php?page=metaslider&id={$this->slider->id}&show_trashed=true" ); ?>">
                                ...
                                <div class="ms-postbox ms-toggle closed" id="metaslider_advanced_settings">
                                    <div class="handlediv"
                                         title="<?php esc_attr_e( 'Click to toggle', 'ml-slider' ); ?>"></div><h3
                                            class="hndle"><span><?php _e( "Advanced Settings", "ml-slider" ) ?></span></h3>
                                    <div class="inside">
                                        <table class="ms-settings">
                                            <tbody>
                                                <?php
                                                $aFields = array(
	                                                ...
	                                                'smartCrop'        => array(
		                                                ...
		                                                'options'  => array(
			                                                'true'         => array(
				                                                'label' => __( "Smart Crop", "ml-slider" ),
				                                                'class' => ''
			                                                ),
			                                                'false'        => array(
				                                                'label' => __( "Standard", "ml-slider" ),
				                                                'class' => ''
			                                                ),
			                                                'disabled'     => array(
				                                                'label' => __( "Disabled", "ml-slider" ),
				                                                'class' => ''
			                                                ),
			                                                'disabled_pad' => array(
				                                                'label' => __( "Disabled (Smart Pad)", "ml-slider" ),
				                                                'class' => 'option flex'
			                                                ),
		                                                ),
	                                                ...
	                                                'direction'        => array(
		                                                ...
		                                                'options'  => array(
			                                                'horizontal' => array(
				                                                'label' => __( "Horizontal", "ml-slider" ),
				                                                'class' => ''
			                                                ),
			                                                'vertical'   => array(
				                                                'label' => __( "Vertical", "ml-slider" ),
				                                                'class' => ''
			                                                ),
		                                                )
	                                                ),
								...
								<div class="ms-delete-save">
									<a @click.prevent="deleteSlideshow()" class='ms-delete-slideshow'
                                       href='<?php echo $url ?>'><?php _e( 'Delete slideshow', 'ml-slider' ); ?></a>
								</div>
                            </div>
                            <?php } ?>
                        </div>
