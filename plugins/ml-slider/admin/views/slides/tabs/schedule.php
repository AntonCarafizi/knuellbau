...
<div class="schedule_placeholder">
	<?php if ( metaslider_pro_is_installed() ) : ?>
        ...
        <a href="https://www.metaslider.com/documentation/i-have-the-pro-add-on-pack-why-isnt-this-feature-working"
           class="button button-primary" target="_blank"><?php _e( 'Why am I seeing this?', 'ml-slider' ); ?></a>
	<?php else : ?>
        <p style="text-base"><?php _e( 'Get the Pro add-on pack now to add a start/end date option to your slides', 'ml-slider' ); ?></p>
        <a href="<?php echo metaslider_get_upgrade_link(); ?>" class="button button-primary"
           target="_blank"><?php _e( 'Get it now!', 'ml-slider' ); ?></a>
	<?php endif; ?>
</div>
