            ...
            <div class="welcome-panel-content">
                ...
                <div class="ms-panel-container">
                    <div class="metaslider-news">
                        ...
                        <p><?php _e( 'MetaSlider is compatible with Gutenberg, allowing you to select and preview your slideshows direcly in the editor.', 'ml-slider' ); ?>
                            <a target="_blank"
                               href="https://www.metaslider.com/metaslider-introduces-slider-blocks-for-gutenberg/"><?php _e( 'Learn more', 'ml-slider' ); ?></a>
                        </p>
                        <picture>
                            <img style="max-width:100%;display:block;padding-right:5rem"
                                 src="<?php echo METASLIDER_ADMIN_URL ?>assets/images/gutenberg-ms.png"
                                 alt="Screenshot from the Gutenberg interface with MetaSlider">
                        </picture>
                    </div>
                    <div class="">
                        <div>
                    ...
                    <div class="">
                        ...
                        <div class="try-gutenberg-action">
                            <p><a class="button button-secondary button-hero install-now"
                                  href="<?php echo wp_nonce_url( admin_url( "admin-post.php?action=metaslider_create_slider" ), "metaslider_create_slider" ); ?>"
                                  data-name="Classic Editor"
                                  data-slug="classic-editor"><?php _e( 'Create blank slideshow', 'ml-slider' ); ?></a>
                            </p>
                        </div>
                    </div>
                </div>
