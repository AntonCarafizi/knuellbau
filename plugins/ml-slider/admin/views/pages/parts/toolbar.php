...
?>
    <metaslider-toolbar inline-template>
        <div id="ms-toolbar" class="flex flex-col items-center bg-white h-16 shadow-sm lg:sticky z-999"
             :class="{'shadow-md':scrolling}">
            <div class="container h-full">
                <div class="flex items-center h-full -mx-4">
                    <div class="flex items-center h-full py-2 px-4">
                        <img style="height:2.3rem;width:2.3rem" width=40 height=40 class="mr-2 rtl:mr-0 rtl:ml-2"
                             src="<?php echo METASLIDER_ADMIN_URL ?>images/metaslider_logo_large.png" alt="MetaSlider">
                            ...
                            <div class="-mx-4 items-center flex h-full">
                                ...
                                <div class="px-4 h-full">
                                    <div class="flex justify-end items-center h-full text-gray">
                                        ...
                                        <button @click.prevent="addSlide()" id="add-new-slide"
                                                class='ms-toolbar-button tipsy-tooltip-bottom-toolbar'
                                                title='<?php _e( "Add a new slide", "ml-slider" ) ?>'>
                                            <i>
                                        ...
                                        <button @click.prevent="preview()" id="preview-slideshow"
                                                title="<?php echo htmlentities( __( 'Save & open preview', 'ml-slider' ) ); ?><br><?php echo htmlentities( _x( '(alt + p)', 'This is a keyboard shortcut.', 'ml-slider' ) ); ?>"
                                                class="ms-toolbar-button tipsy-tooltip-bottom-toolbar"
                                                :class="{disabled: $parent.saving}">
                                            <i>
                                        ...
                                        <a class="ms-toolbar-button tipsy-tooltip-bottom-toolbar"
                                           title="<?php _e( 'Read the documentation', 'ml-slider' ); ?>"
                                           href="https://www.metaslider.com/documentation/" target="_blank">
                                            <i>
                                        ...
                                        <a class="ms-toolbar-button tipsy-tooltip-bottom-toolbar"
                                           title="<?php _e( 'Add a new slideshow', 'ml-slider' ); ?>"
                                           href="<?php echo wp_nonce_url( admin_url( "admin-post.php?action=metaslider_create_slider" ), "metaslider_create_slider" ); ?>">
                                            <i>
                                                <font-awesome-icon transform="grow-2"
                                                                   icon="plus-square"></font-awesome-icon>
                                            </i>
                                            <span><?php _e( 'New', 'ml-slider' ); ?></span>
                                        </a>

                                        <button @click.prevent="duplicate()"
                                                title="<?php _e( 'Duplicate this slideshow', 'ml-slider' ); ?>"
                                                class="ms-toolbar-button tipsy-tooltip-bottom-toolbar"
                                                :class="{disabled: duplicating}">
                                            <i>
										...
										<?php ob_start(); ?>
                                        <button @click.prevent="showCSSManagerNotice()"
                                                title="<?php esc_attr_e( 'Add custom CSS', 'ml-slider' ); ?><br> - <?php esc_attr_e( 'press to learn more', 'ml-slider' ); ?> -"
                                                class="ms-toolbar-button tipsy-tooltip-bottom-toolbar"
                                                :class="{disabled:true}">
                                            <i>
                                                <font-awesome-icon transform="grow-2"
                                                                   icon="file-code"></font-awesome-icon>
                                            </i>
                                        ...
                                        <button @click.prevent="save()"
                                                title="<?php _e( 'Save slideshow', 'ml-slider' ); ?>" id="ms-save"
                                                class="ms-toolbar-button tipsy-tooltip-bottom-toolbar"
                                                :class="{disabled: locked}">
                                            <i v-if="locked">
                                                <font-awesome-icon transform="grow-2" spin
