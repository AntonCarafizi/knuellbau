...
<div class="flex p-6 mb-16">
    <div class="metaslider_col <?php echo $width; ?>">
        ...
        <table class="metaslider_feat_table shadow">
            ...
            <tr>
                <th></th>
                <th><img src="<?php echo METASLIDER_ADMIN_URL . 'images/notices/metaslider_logo.png'; ?>"
                         alt="<?php esc_attr_e( 'MetaSlider logo', 'ml-slider' ); ?>" width="80"
                         height="80">MetaSlider<br><span><?php _e( 'free', 'ml-slider' ); ?></span></th>
                <th><img src="<?php echo METASLIDER_ADMIN_URL . 'images/notices/metaslider_logo.png'; ?>"
                         alt="<?php esc_attr_e( 'MetaSlider logo', 'ml-slider' ); ?>" width="80"
                         height="80"><?php _e( 'Add-ons', 'ml-slider' ); ?>
                    <br><span><?php _e( 'pro', 'ml-slider' ); ?></span></th>
            </tr>
            </thead>
            <tbody>
            <tr>
            ...
            <tr>
                <td><i class="metaslider-premium-image">
                    ...
                    <p><?php _x( 'Including FlexSlider, Nivo Slider and we will soon be adding more.', '"FlexSlider" and "Nivo Slider" are plugin names.', 'ml-slider' ); ?></p>
                </td>
                <td><i class="dashicons dashicons-yes" aria-label="<?php esc_attr_e( 'Yes', 'ml-slider' ); ?>"></i></td>
                <td><i class="dashicons dashicons-yes" aria-label="<?php esc_attr_e( 'Yes', 'ml-slider' ); ?>"></i></td>
            </tr>
            <tr>
                <td><i class="metaslider-premium-image">
                    ...
                    <p><?php _ex( 'Our word to keep MetaSlider compatible with the latest versions of WordPress.', 'Keep the plugin name "MetaSlider" when possible', 'ml-slider' ); ?></p>
                </td>
                <td><i class="dashicons dashicons-yes" aria-label="<?php esc_attr_e( 'Yes', 'ml-slider' ); ?>"></i></td>
                <td><i class="dashicons dashicons-yes" aria-label="<?php esc_attr_e( 'Yes', 'ml-slider' ); ?>"></i></td>
            </tr>
            <tr>
                <td><i class="metaslider-premium-image">
                    ...
                    <p><?php _ex( 'Unique Smart Crop functionality ensures your slides are perfectly resized.', 'Keep the branding "Smart Crop" together when possible', 'ml-slider' ); ?></p>
                </td>
                <td><i class="dashicons dashicons-yes" aria-label="<?php esc_attr_e( 'Yes', 'ml-slider' ); ?>"></i></td>
                <td><i class="dashicons dashicons-yes" aria-label="<?php esc_attr_e( 'Yes', 'ml-slider' ); ?>"></i></td>
            </tr>
            <tr>
                <td><i class="metaslider-premium-image">
                    ...
                    <p><?php _e( 'Easily allow users to navigate your slideshows by thumbnails.', 'ml-slider' ); ?></p>
                </td>
                <td><i class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e( 'No', 'ml-slider' ); ?>"></i>
                </td>
                <td><i class="dashicons dashicons-yes" aria-label="<?php esc_attr_e( 'Yes', 'ml-slider' ); ?>"></i></td>
            </tr>
            <tr>
                <td><i class="metaslider-premium-image">
                    ...
                    <p><?php _ex( 'Easily include responsive high definition YouTube and Vimeo videos.', '"YouTube" and "Vimeo" are brand names.', 'ml-slider' ); ?></p>
                </td>
                <td><i class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e( 'No', 'ml-slider' ); ?>"></i>
                </td>
                <td><i class="dashicons dashicons-yes" aria-label="<?php esc_attr_e( 'Yes', 'ml-slider' ); ?>"></i></td>
            ...
            <tr>
                <td><i class="metaslider-premium-image">
                    ...
                    <p><?php _e( 'Create completely customized HTML slides using the inline editor.', 'ml-slider' ); ?></p>
                </td>
                <td><i class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e( 'No', 'ml-slider' ); ?>"></i>
                </td>
                <td><i class="dashicons dashicons-yes" aria-label="<?php esc_attr_e( 'Yes', 'ml-slider' ); ?>"></i></td>
            ...
            <tr>
                <td><i class="metaslider-premium-image">
                    ...
                    <p><?php _e( 'Add layers to your slides with over 50 available transition effects.', 'ml-slider' ); ?></p>
                </td>
                <td><i class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e( 'No', 'ml-slider' ); ?>"></i>
                </td>
                <td><i class="dashicons dashicons-yes" aria-label="<?php esc_attr_e( 'Yes', 'ml-slider' ); ?>"></i></td>
            ...
            <tr>
                <td><i class="metaslider-premium-image">
                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none"
                             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                             aria-hidden="true" data-reactid="501">
                            <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                            <circle cx="12" cy="12" r="3"></circle>
                        </svg>
                    </i>
                    <h4><?php _e( "Toggle your slide's visibility", 'ml-slider' ); ?></h4>
                    <p><?php _e( 'Allows you to hide any slide, without having to delete them.', 'ml-slider' ); ?></p>
                </td>
                <td><i class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e( 'No', 'ml-slider' ); ?>"></i>
                </td>
                <td><i class="dashicons dashicons-yes" aria-label="<?php esc_attr_e( 'Yes', 'ml-slider' ); ?>"></i></td>
            ...
            <tr>
                <td><i class="metaslider-premium-image">
                    ...
                    <p><?php _e( 'Have your specific queries addressed directly by our experts', 'ml-slider' ); ?></p>
                </td>
                <td><i class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e( 'No', 'ml-slider' ); ?>"></i>
                </td>
                <td><i class="dashicons dashicons-yes" aria-label="<?php esc_attr_e( 'Yes', 'ml-slider' ); ?>"></i></td>
