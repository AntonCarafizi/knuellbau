<template>
    <div id="main">
        ...
        <content-section title="Examples" class="examples">
            ...
            <example action-title="Regular Alert" v-on:action="openExample('regularAlert')"
                     :code="examples.regularAlert" language="xml">
                <sweet-modal ref="regularAlert">
                    This is an alert.
                </sweet-modal>
            </example>

            <example action-title="Success Alert" v-on:action="openExample('successAlert')"
                     :code="examples.successAlert" language="xml">
                <sweet-modal ref="successAlert" icon="success">
                    This is a success!
                </sweet-modal>
            </example>

            <example action-title="Warning Alert" v-on:action="openExample('warningAlert')"
                     :code="examples.warningAlert" language="xml">
                <sweet-modal ref="warningAlert" icon="warning">
                    This is a warning!
                </sweet-modal>
            </example>

            <example action-title="Alert with Error and Button" v-on:action="openExample('errorAndButtonAlert')"
                     :code="examples.errorAndButtonAlert" language="xml">
            ...
            <example action-title="Dark with Blocking Error" v-on:action="openExample('darkWithBlockingError')"
                     :code="examples.darkWithBlockingError" language="xml">
                <sweet-modal ref="darkWithBlockingError" icon="error" hide-close-button blocking overlay-theme="dark"
                             modal-theme="dark">
                    This is an error…

                    <sweet-button slot="button" color="red" v-on:click="closeExample('darkWithBlockingError')">Press
                        this Button
                    </sweet-button>
                </sweet-modal>
            </example>

            <example action-title="Dark with HTML Content" v-on:action="openExample('darkWithHTMLContent')"
                     :code="examples.darkWithHTMLContent" language="xml">
                <sweet-modal ref="darkWithHTMLContent" modal-theme="dark" overlay-theme="dark">
                    This is <b>HTML</b>-<i>Content</i>.
                    <br/><br/>

                    <iframe width="560" height="315" src="https://www.youtube.com/embed/4xgx4k83zzc" frameborder="0"
                            allowfullscreen></iframe>
                </sweet-modal>
            </example>

            <example action-title="Additional Window Controls" v-on:action="openExample('additionalWindowControls')"
                     :code="examples.additionalWindowControls" language="xml">
            ...
            <example action-title="Ultra Wide" v-on:action="openExample('ultraWide')" :code="examples.ultraWide"
                     language="xml">
            ...
            <example action-title="Tabbed Modal" v-on:action="openExample('tabbedModal')" :code="examples.tabbedModal"
                     language="xml">
            ...
            <example action-title="Tabbed Modal with Icons" v-on:action="openExample('tabbedModalWithIcons')"
                     :code="examples.tabbedModalWithIcons" language="xml">
                <sweet-modal ref="tabbedModalWithIcons">
                    ...
                    <sweet-modal-tab title="Tab 3" id="tab3" :icon="icons.compare" disabled>Tab 3 is disabled
                    </sweet-modal-tab>
                    <!-- icons is an object containing SVG strings -->
                </sweet-modal>
            </example>

            <example action-title="Tabbed Modal with Title" v-on:action="openExample('tabbedModalWithTitle')"
                     :code="examples.tabbedModalWithTitle" language="xml">
            ...
            <example action-title="Tabbed Modal with Icons and Buttons"
                     v-on:action="openExample('tabbedModalWithIconsAndButtons')"
                     :code="examples.tabbedModalWithIconsAndButtons" language="xml">
            ...
            <example action-title="Very Long Modal" v-on:action="openExample('longModal')" :code="examples.longModal"
                     language="xml">
        ...
        <content-section title="Install Globally" class="install">
            ...
            <ol>
                ...
                <li>
                    ...
                    <sweet-code light><code class="javascript">import SweetModal from 'sweet-modal-vue/plugin.js'<br/>Vue.use(SweetModal)</code>
                    </sweet-code>
                </li>
            </ol>
        </content-section>
        ...
        <content-section title="Install per Component" class="install">
            ...
            <ol>
                ...
                <li>
                    ...
                    <sweet-code light><code class="javascript">import { SweetModal, SweetModalTab } from
                        'sweet-modal-vue'</code></sweet-code>
                </li>
        ...
        <content-section title="Usage" class="install usage">
            <ol>
                ...
                <li>
                    Give your modal a ref, i.e.
                    <sweet-code inline light><code language="xml">ref="modal"</code></sweet-code>
                    .
                </li>

                <li>
                    Open your modal by calling
                    <sweet-code inline light><code language="javascript">this.$refs.modal.open()</code></sweet-code>
                    .<br/>
                    If your modal has tabs and you want to open a specific tab, supply the tab's ID as the first
                    argument:
                    <sweet-code inline light><code language="javascript">this.$refs.modal.open('tab1')</code>
                    </sweet-code>
                </li>
            </ol>
        </content-section>
...
--&gt;</pre>
        ...
        <footer>
            <div class="copyright">
                ...
                For help, visit <a href="https://github.com/adeptoas/sweet-modal-vue/issues">the issues section</a> of
                this repository.
            </div>
        ...
        computed: {
            ...
            examples() {
                return {
                    ...
                    tabbedModalWithTitle: `
            <sweet-modal title="This is a Tabbed Modal">
                                    <sweet-modal-tab title="Tab 1" id="tab1" :icon="icons.hexagon">Contents of Tab 1</sweet-modal-tab>
                                    <sweet-modal-tab title="Tab 2" id="tab2" :icon="icons.flower">Contents of Tab 2</sweet-modal-tab>
                                    <sweet-modal-tab title="Tab 3" id="tab3" :icon="icons.compare" disabled>Tab 3 is disabled</sweet-modal-tab>
<!-- icons is an object containing SVG strings -->
            ...
            :
                ...
                3
                is
                disabled < /sweet-modal-tab>
                <!-- icons is an object containing SVG strings -->

                < sweet - button
                slot = "button"
                color = "light-grey" > Action
                2 < /sweet-button>
                < sweet - button
                slot = "button" > Action
                1 < /sweet-button>
